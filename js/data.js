...
const TRACKS = [
  ...
  // ---- Lote 2: +60 faixas ----
  { titulo: "Bambu ao Vento",              tags: ["Relaxamento", "Meditação"],          file: "51-bambu-ao-vento.mp3" },
  { titulo: "Bambu e Silêncio",            tags: ["Relaxamento", "Sono"],               file: "52-bambu-e-silencio.mp3" },
  { titulo: "Deriva das Estrelas",         tags: ["Relaxamento", "Meditação"],          file: "53-deriva-das-estrelas.mp3" },
  { titulo: "Voo Celeste",                 tags: ["Relaxamento", "Sono"],               file: "54-voo-celeste.mp3" },
  { titulo: "Eco Celestial",               tags: ["Meditação", "Cura"],                 file: "55-eco-celestial.mp3" },
  { titulo: "Vibração das Esferas",        tags: ["Meditação", "Terceiro Olho"],        file: "56-vibracao-das-esferas.mp3" },
  { titulo: "Quietude das Alturas",        tags: ["Relaxamento", "Sono"],               file: "57-quietude-das-alturas.mp3" },
  { titulo: "Repouso Estelar",             tags: ["Sono", "Relaxamento"],               file: "58-repouso-estelar.mp3" },
  { titulo: "Serenidade Cósmica",          tags: ["Meditação", "Cura"],                 file: "59-serenidade-cosmica.mp3" },
  { titulo: "Fundo do Oceano",             tags: ["Relaxamento", "Cura"],               file: "60-fundo-do-oceano.mp3" },
  { titulo: "Abismo Azul",                 tags: ["Relaxamento", "Sono"],               file: "61-abismo-azul.mp3" },
  { titulo: "Silêncio Profundo",           tags: ["Meditação", "Sono"],                 file: "62-silencio-profundo.mp3" },
  { titulo: "Profundezas do Ser",          tags: ["Autoconhecimento", "Meditação"],     file: "63-profundezas-do-ser.mp3" },
  { titulo: "Véu Violeta",                 tags: ["Meditação", "Terceiro Olho"],        file: "64-veu-violeta.mp3" },
  { titulo: "Silêncio Violeta",            tags: ["Meditação", "Sono"],                 file: "65-silencio-violeta.mp3" },
  { titulo: "Ecos da Pedra Sagrada",       tags: ["Terceiro Olho", "Cura"],             file: "66-ecos-da-pedra-sagrada.mp3" },
  { titulo: "Ressonância da Pedra",        tags: ["Cura", "Meditação"],                 file: "67-ressonancia-da-pedra.mp3" },
  { titulo: "Entre as Estrelas",           tags: ["Relaxamento", "Sono"],               file: "68-entre-as-estrelas.mp3" },
  { titulo: "Suspenso no Cosmos",          tags: ["Meditação", "Foco"],                 file: "69-suspenso-no-cosmos.mp3" },
  { titulo: "Cristal e Silêncio",          tags: ["Relaxamento", "Cura"],               file: "70-cristal-e-silencio.mp3" },
  { titulo: "Vidro e Névoa",               tags: ["Relaxamento", "Sono"],               file: "71-vidro-e-nevoa.mp3" },
  { titulo: "Amanhecer Dourado",           tags: ["Prosperidade", "Meditação"],         file: "72-amanhecer-dourado.mp3" },
  { titulo: "Aurora de Ouro",              tags: ["Prosperidade", "Cura"],              file: "73-aurora-de-ouro.mp3" },
  { titulo: "Manhã que Sussurra",          tags: ["Relaxamento", "Meditação"],          file: "74-manha-que-sussurra.mp3" },
  { titulo: "Sussurro da Alvorada",        tags: ["Prosperidade", "Autoconhecimento"],  file: "75-sussurro-da-alvorada.mp3" },
  { titulo: "Chuva no Vidro",              tags: ["Relaxamento", "Sono"],               file: "76-chuva-no-vidro.mp3" },
  { titulo: "Gotas de Vidro",              tags: ["Relaxamento", "Cura"],               file: "77-gotas-de-vidro.mp3" },
  { titulo: "Geometria Ressonante",        tags: ["Terceiro Olho", "Foco"],             file: "78-geometria-ressonante.mp3" },
  { titulo: "Formas do Infinito",          tags: ["Terceiro Olho", "Meditação"],        file: "79-formas-do-infinito.mp3" },
  { titulo: "Ressonância Sagrada",         tags: ["Meditação", "Cura"],                 file: "80-ressonancia-sagrada.mp3" },
  { titulo: "Som Sagrado",                 tags: ["Cura", "Meditação"],                 file: "81-som-sagrado.mp3" },
  { titulo: "Terceiro Olho Cintilante",    tags: ["Terceiro Olho", "Autoconhecimento"], file: "82-terceiro-olho-cintilante.mp3" },
  { titulo: "Deriva Galáctica",            tags: ["Relaxamento", "Sono"],               file: "83-deriva-galactica.mp3" },
  { titulo: "Silêncio Galáctico",          tags: ["Meditação", "Sono"],                 file: "84-silencio-galactico.mp3" },
  { titulo: "Pulso das Galáxias",          tags: ["Meditação", "Foco"],                 file: "85-pulso-das-galaxias.mp3" },
  { titulo: "Batimento Cósmico",           tags: ["Foco", "Meditação"],                 file: "86-batimento-cosmico.mp3" },
  { titulo: "O Espaço Entre as Notas",     tags: ["Meditação", "Autoconhecimento"],     file: "87-o-espaco-entre-as-notas.mp3" },
  { titulo: "Meditação Estelar",           tags: ["Meditação", "Terceiro Olho"],        file: "88-meditacao-estelar.mp3" },
  { titulo: "Poeira de Estrelas",          tags: ["Relaxamento", "Sono"],               file: "89-poeira-de-estrelas.mp3" },
  { titulo: "Brilho das Estrelas",         tags: ["Relaxamento", "Cura"],               file: "90-brilho-das-estrelas.mp3" },
  { titulo: "Luz Estelar",                 tags: ["Meditação", "Cura"],                 file: "91-luz-estelar.mp3" },
  { titulo: "Águas Tranquilas",            tags: ["Relaxamento", "Sono"],               file: "92-aguas-tranquilas.mp3" },
  { titulo: "Lago em Paz",                 tags: ["Autoconhecimento", "Relaxamento"],   file: "93-lago-em-paz.mp3" },
  { titulo: "Espelho Sereno",              tags: ["Autoconhecimento", "Meditação"],     file: "94-espelho-sereno.mp3" },
  { titulo: "Correnteza Suave",            tags: ["Relaxamento", "Sono"],               file: "95-correnteza-suave.mp3" },
  { titulo: "Remanso",                     tags: ["Relaxamento", "Cura"],               file: "96-remanso.mp3" },
  { titulo: "Águas Paradas",               tags: ["Sono", "Relaxamento"],               file: "97-aguas-paradas.mp3" },
  { titulo: "Canto das Águas Serenas",     tags: ["Cura", "Relaxamento"],               file: "98-canto-das-aguas-serenas.mp3" },
  { titulo: "Voz do Lago",                 tags: ["Relaxamento", "Meditação"],          file: "99-voz-do-lago.mp3" },
  { titulo: "Silêncio Interior",           tags: ["Autoconhecimento", "Meditação"],     file: "100-silencio-interior.mp3" },
  { titulo: "Paz que Habita",              tags: ["Autoconhecimento", "Cura"],          file: "101-paz-que-habita.mp3" },
  { titulo: "Deriva do Terceiro Olho",     tags: ["Terceiro Olho", "Meditação"],        file: "102-deriva-do-terceiro-olho.mp3" },
  { titulo: "Portal Interior",             tags: ["Terceiro Olho", "Autoconhecimento"], file: "103-portal-interior.mp3" },
  { titulo: "Maré da Serenidade",          tags: ["Relaxamento", "Sono"],               file: "104-mare-da-serenidade.mp3" },
  { titulo: "Ondas Tranquilas",            tags: ["Relaxamento", "Cura"],               file: "105-ondas-tranquilas.mp3" },
  { titulo: "Ressonância Violeta",         tags: ["Meditação", "Terceiro Olho"],        file: "106-ressonancia-violeta.mp3" },
  { titulo: "Luz Violeta",                 tags: ["Cura", "Terceiro Olho"],             file: "107-luz-violeta.mp3" },
